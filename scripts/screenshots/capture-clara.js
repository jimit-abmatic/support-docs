...
async function captureClara() {
  ...
  try {
    ...
    // Navigate to Clara ABM
    console.log('📸 Navigating to Clara ABM...');
    await page.goto(`${config.baseUrl}/ai-agents/abm`, { waitUntil: 'networkidle' });
    await page.waitForTimeout(2000);

    // Capture screenshot
    const outputPath = path.join(config.outputDir, 'clara-abm-main.png');
