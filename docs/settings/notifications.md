...
Stay informed about important events across your Abmatic AI account with customizable notification preferences. Control exactly which updates you want to receive so you never miss critical engagement signals.

## Why Configure Notifications?

- **Stay responsive** - Get instant alerts when high-value accounts engage with your site
- **Track campaign performance** - Know immediately when campaigns have activity
- **Monitor integrations** - Be notified of CRM sync status and any issues
- **Manage resources** - Track credit usage to avoid service interruptions
...
- **IP Reveal** - Know immediately when target accounts visit your site
- **Form Fills** - Get alerts when leads submit forms
- **Accounts** - Track account activity in real-time

### For Marketing Teams

Enable notifications for:
- **Campaigns** - Monitor campaign performance
- **Target Groups** - Track audience changes
- **Form Fills** - Measure conversion activity

### For Operations

Enable notifications for:
- **CRM** - Monitor integration health
- **Export** - Track data export completion
- **Credits** - Prevent service interruptions
